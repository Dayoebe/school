<div class="md:grid grid-cols-12 gap-2">
    ...
    <x-select id="section-id" name="section_id" label="Choose a section *" group-class="col-span-6"
    ...
    <x-input id="admission-number" name="admission_number" label="Admission number" :value="$admissionNumber"
        group-class="col-span-6" />

    <x-input type="date" name="admission_date" id="admission_date" label="Date of admission *" :value="$admissionDate"
        autocomplete="off" group-class="col-span-6" />
