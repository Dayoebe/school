<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="bg-gradient-to-r from-green-600 to-teal-600 px-6 py-4">
        <div class="flex items-center justify-between">
            <h3 class="text-xl font-bold text-white">
                <i class="fas fa-lightbulb mr-2"></i>Create New Subject
            </h3>
    ...
    <form wire:submit="createSubject" class="p-6">
        <div class="space-y-6">
            <!-- Basic Information -->
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-3">
                    Assign to Classes * 
                    <span class="text-gray-500 font-normal">(Select all classes that will take this subject)</span>
                </label>
                    ...
                    @foreach($classes as $class)
                        <div class="flex items-center">
                            <button type="button" 
                                    ...
                                    class="w-full text-left px-4 py-3 rounded-lg border-2 transition {{ in_array($class->id, $selectedClasses) ? 'bg-green-100 border-green-500 text-green-800' : 'bg-white border-gray-300 text-gray-700 hover:border-green-300' }}">
                                <div class="flex items-center justify-between">
            ...
            <div class="border-t pt-6">
                        ...
                        @forelse($this->teachers as $teacher)
                            <div class="flex items-center justify-between p-3 hover:bg-white rounded border-b last:border-b-0">
                                ...
                                <button type="button" 
                                        ...
                                        class="px-4 py-2 rounded-lg {{ in_array($teacher->id, $selectedTeachers) ? 'bg-green-100 text-green-800 border-2 border-green-500' : 'bg-gray-200 text-gray-800 hover:bg-gray-300' }}">
                ...
                <!-- Selected Teachers with Assignment Options -->
        ...
        <div class="flex justify-end gap-3 mt-8 pt-6 border-t">
            ...
            <button type="submit" 
                    class="px-6 py-2.5 bg-gradient-to-r from-green-600 to-teal-600 text-white font-semibold rounded-lg hover:from-green-700 hover:to-teal-700 shadow-lg">
