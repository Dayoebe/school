    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Fee Categories</h2>
                    <p class="text-gray-600 mt-1">Manage your school's fee categories</p>
                </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                                    {{ $category->fees_count }} {{ Str::plural('fee', $category->fees_count) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    @can('update fee category')
                                    ...
                                    @endcan
                                    @can('delete fee category')
                                        <button wire:click="deleteFeeCategory({{ $category->id }})" 
                                                wire:confirm="Are you sure you want to delete this fee category?"
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-lg">No fee categories found</p>
                                    <p class="text-gray-400 text-sm mt-1">Create your first fee category to get started</p>
                                    @can('create fee category')
                                        <a href="{{ route('fee-categories.create') }}" 
                                           wire:navigate
