<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Edit Fee Category</h2>
                <p class="text-gray-600 mt-1">Update fee category information</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form wire:submit.prevent="updateFeeCategory" class="p-6">
            <div class="space-y-6">
                <!-- Name -->
                <div>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i>Update Fee Category
                    </button>
                </div>
            </div>
        </form>
