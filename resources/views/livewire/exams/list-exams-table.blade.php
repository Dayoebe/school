<div class="card">
    <div class="card-header">
        <h4 class="card-title">Exam list for Term {{ auth()->user()->school->semester->name}} </h4>
    </div>
    <div class="card-body">
        <livewire:common.datatable  uniqueId="list-exams-table" :model="App\Models\Exam::class"
        :filters="[
