                            ...
                            @foreach ($subjects as $subject)
                                <tr>
                                    ...
                                    @php
                                        ...
                                        if (isset($selectedClass) && $selectedClass?->classGroup) {
                                            $grade = \App\Models\GradeSystem::where('class_group_id', $selectedClass->classGroup->id)
                                                ->where('grade_from', '<=', round($percentage))
                                                ->where('grade_till', '>=', round($percentage))
                                                ->first();
                                        }
                                    @endphp
