        ...
        @if ($classes->isNotEmpty())
            ...
            @isset($class)
                <div wire:loading.remove.delay>
                    <livewire:datatable :wire:key="Str::random()" :model="App\Models\MyClass::class" uniqueId="section-list-table"
                        :filters="[['name' => 'find', 'arguments' => [$class]], ['name' => 'sections']]" :columns="[
                            ['property' => 'name'],
                            [
                                'type' => 'dropdown',
                                'name' => 'actions',
