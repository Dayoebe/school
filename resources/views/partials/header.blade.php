...
<header x-data="{ mobileMenuOpen: false, dropdownOpen: false }"
        ...
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center space-x-6">
                ...
                <nav class="hidden lg:flex items-center space-x-6 font-medium animate__animated animate__fadeIn">
                    <a href="{{ route('home') }}"
                        class=" hover:uppercase hover:text-blue-300 text-grey-600 px-4 py-2 rounded-lg shadow transition transform hover:scale-105">Home</a>
                    <a href="{{ route('about') }}"
                        class="hover:uppercase hover:text-blue-300 text-grey-600 px-4 py-2 rounded-lg shadow transition transform hover:scale-105">About</a>
                    <a href="{{ route('admission') }}"
                        class="hover:uppercase hover:text-blue-300 text-grey-600 px-4 py-2 rounded-lg shadow transition transform hover:scale-105">Admission</a>
                    <a href="{{ route('gallery') }}"
                        class="hover:uppercase hover:text-blue-300 text-grey-600 px-4 py-2 rounded-lg shadow transition transform hover:scale-105">Gallery</a>
                    <a href="{{ route('contact') }}"
                        class="hover:uppercase hover:text-blue-300 text-grey-600 px-4 py-2 rounded-lg shadow transition transform hover:scale-105">Contact</a>

                    <!-- Dropdown -->
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="hover:uppercase hover:text-blue-300 text-grey-600 px-4 py-2 rounded-lg shadow transition transform hover:scale-105 flex items-center gap-1">
                            More
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <a href="#"
                                class="hover:uppercase transition transform hover:scale-105 block px-4 py-2 hover:bg-blue-100">Academics</a>
                            <a href="#"
                                class="hover:uppercase transition transform hover:scale-105 block px-4 py-2 hover:bg-blue-100">News</a>
                            <a href="#"
                                class="hover:uppercase transition transform hover:scale-105 block px-4 py-2 hover:bg-blue-100">Careers</a>
                        </div>
                    </div>
                ...
                <div class="hidden lg:flex space-x-4 items-center animate__animated animate__fadeInRight">
                    @auth
                        <a href="{{ route('dashboard') }}"
                            class="hover:uppercase flex items-center space-x-2 hover:text-blue-300">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="hover:uppercase bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow transition transform hover:scale-105">Login</a>
                    @endauth
                </div>
    ...
    <div x-show="mobileMenuOpen" x-transition
        ...
        <a href="{{ route('admission') }}"
            class="hover:uppercase block py-2 text-white hover:text-blue-300">Admission</a>
        ...
        <a href="{{ route('admission') }}"
            class="hover:uppercase block py-2 text-white font-semibold bg-blue-500 rounded text-center hover:bg-blue-600">Apply
            Now</a>
        ...
        <div class="border-t border-blue-900 mt-2 pt-2 space-y-1">
            @auth
                <a href="{{ route('dashboard') }}"
                    class="hover:uppercase flex items-center space-x-2 text-white hover:text-blue-300">
