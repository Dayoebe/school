...
return new class() extends Migration {
    public function up(): void
    {
        Schema::create('promotions', static function (Blueprint $table) {
            ...
            $table->foreignId('old_section_id')->constrained('sections')->nullable()->onDelete('cascade')->onUpdate('cascade');
            $table->foreignId('new_section_id')->constrained('sections')->nullable()->onDelete('cascade')->onUpdate('cascade');
